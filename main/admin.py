...
class YearAdmin(admin.ModelAdmin):
    list_display = ('year', 'shashti', 'saptami', 'ashtami',
                    'sandhi', 'navami', 'dashami')
    ...
    fieldsets = (
        ...
        (_('Live Video of Maa Durga coming from potuapara to Home'),
         {'fields': ('maacomevid',)}),
        (_('Puja Dates'), {'fields': ('shashti', 'saptami',
         'ashtami', 'sandhi', 'navami', 'dashami')}),
...
class VideosAdmin(admin.ModelAdmin):
    list_display = ('streamingvideoheader', 'streamingplatform',
                    'yearmodel', 'day', 'live', 'test')
    list_filter = (
    ...
    fieldsets = (
        ...
        (_('Day'), {'fields': ('day',)}),
        (_('Test'), {'fields': ('test',)}),
        (_('Streaming Video Data'), {'fields': (
            'streamingvideoheader', 'streamingplatform', 'streamingvideodescription')}),
        (_('Streaming Video Links Data'), {
         'fields': ('streamingvideolink', 'live',)+readonly_fields})
    )
