    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maadurgaphoto1', filer.fields.image.FilerImageField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='maa_durga_photo_extra', to=settings.FILER_IMAGE_MODEL, verbose_name='Corresponding year Maa Durga Photo Extra')),
